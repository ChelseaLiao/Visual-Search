...
namespace VRQuestionnaireToolkit
{
    public class PageController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //button_backTotask = GameObject.Find("ButtonToTask");
        ...
        public void GoToNextPage()
        {
            ...
            if (CheckMandatoryQuestionsAnswered() || _pageFactory.CurrentPage == 0)
            {
                ...
                GameObject q_task = GameObject.Find("Q_Task");
                q_task.SetActive(false);
                ...
                if (_pageFactory.PageList.Count - 1 == _pageFactory.CurrentPage)
                {
                    ...
                    TextMeshProUGUI descriptionText = text.GetComponentInChildren<TextMeshProUGUI>();
                    int counter = dataManager.getBlockCounter() + 1;
                    descriptionText.text = "Click the button and go to the next task ("+ counter +"/6)";
                    q_task.SetActive(true);
        ...
        public void BackToTaskButtonEvent()
        {
            //Debug.Log("BackToTaskButtonEvent");
            DataManager dm = GameObject.Find("DataManager").GetComponent<DataManager>();
            dm.nextScene("Questionnaire", "05_VRception");
